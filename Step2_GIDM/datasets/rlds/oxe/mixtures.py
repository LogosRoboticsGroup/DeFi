...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    # === UniVLA Magic Soup++ without human ===
    "omni_magic_soup_plus_plus_wo_human": [
        ("fractal20220817_data", 0.5),                
        ("kuka", 0.1),
        ("bridge_dataset", 1.0),                                   
        ("taco_play", 2.0),
    ...
    "omni_magic_soup_plus_plus_wo_navi": [
        ("fractal20220817_data", 0.5),                
        ("kuka", 0.1),
        ("bridge_dataset", 1.0),                                   
        ("taco_play", 2.0),
    ...
    # === UniVLA debug example ===
    "omni_magic_soup_plus_plus_example_bridge": [
        ("bridge_dataset", 1.0),                
    ],

    "omni_magic_soup_plus_plus_example_rt1": [
        ("fractal20220817_data", 1.0),                
    ],
