...
if __name__ == "__main__":
    ...
    parser.add_argument("--clip_model_path", type=str, default="ckpt/openai_clip_vit_base_patch32")
    parser.add_argument("--val_dataset_dir", type=str, default='data/opensource_robotdata/bridge')
