...
def handle_memory_attention(enable_torch_2_attn, unet): 
    try:
...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    # Enable torch_2_attn if available
    handle_memory_attention(enable_torch_2_attn, unet)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="video_conf/train_calvin_svd.yaml")
