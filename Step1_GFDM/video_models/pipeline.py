    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latents = self.scheduler.step(noise_pred, t, latents).prev_sample  # torch.Size([4, 16, 4, 32, 32])
...
# 主要功能：最灵活的视频生成管道，支持多种条件类型
# 适用场景：需要灵活组合图像和文本条件的视频生成任务
